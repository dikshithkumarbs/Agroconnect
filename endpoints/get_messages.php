...
$chat_result = getChatMessagesPaginated($user_id, $user_role, $other_id, $last_message_id, $limit);
...
if ($chat_result['success']) {
    ...
    // Mark messages as delivered (this is now handled in getChatMessagesPaginated)
} else {
